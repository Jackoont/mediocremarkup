  ...
  /* ── 8. SCROLL-PINNED DIVE REVEAL ── */
  {
    ...
    const PHASE_COPY = [
      ...
      },
      {
        ...
        title:   'HTML starts locking into a visual system.',
      ...
      },
      {
        ...
        title:   'Structure turns expressive without losing speed.',
      ...
      },
      {
        ...
        title:   'Release should feel authored, not merely finished.',
