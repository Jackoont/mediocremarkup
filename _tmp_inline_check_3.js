  ...
  /* ── 8. SCROLL-PINNED DIVE REVEAL ── */
  {
    ...
    const PHASE_COPY = [
      ...
      },
      {
        ...
        title:   'Assemble',
        body:    'Tagged sections, proof blocks, and conversion modules arrive like real markup becoming form.',
        ph:      'ASSEMBLE',
        rail:    'build · assemble',
      },
      {
        ...
        title:   'Style',
        body:    'The code pass gives those modules rhythm, contrast, and motion without sliding into template sludge.',
        ph:      'CODE',
        rail:    'build · code',
      },
      {
        ...
        title:   'Ship',
        body:    'The end state should look like deliberate markup art that also happens to convert.',
        ph:      'SHIPPED',
        rail:    'build · shipped',
      },
    ];
    ...
    function applyReveal() {
      ...
      const driftX = Math.sin(displayRatio * Math.PI * 1.15) * 4;
      const driftY = Math.cos(displayRatio * Math.PI * 1.6) * -2 - displayRatio * 6;
      const rotY = (displayRatio - 0.5) * 1.4;
      const rotX = Math.sin(displayRatio * Math.PI * 1.4) * -0.9;
      ...
      if (mask) {
        mask.style.opacity = Math.max(0, Math.min(0.28, displayRatio * 0.28)).toFixed(3);
      }
